...
class MFRC522:
    ...
    def _tocard(self, cmd, send):
        ...
        while True:
            n = self._rreg(0x04)
            i -= 1
            #if 2000 - i == 1 or 2000 - i == 500 or 2000 - i == 1000 or 2000 - i == 1500 or 2000 - i == 2000:
                #print(f"Waiting for IRQ... Attempt {2000 - i}, n={n}")  # Debug print
        ...
        if i:
            #print(f"Response received: {i}, {n}, {self._rreg(0x06)}")  # Debug print
            if (self._rreg(0x06) & 0x1B) == 0x00:
                ...
                #print(f"Error: Status register check failed: {self._rreg(0x06)}") 
                stat = self.ERR
